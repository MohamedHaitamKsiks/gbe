...
namespace GBE
{
    ...
    void Cpu::_Call(uint16_t adr16, InstructionResult &result, bool isHaltBug)
    {
    ...
    void Cpu::CallImm16(const Instruction &instr, InstructionResult &result)
    {
        //  operands
        ...
        // execute
        _Call(imm16Value, result);
    }

    void Cpu::CallCC_Imm16(const Instruction &instr, InstructionResult &result)
    {
        // operands
    ...
    void Cpu::JumpHL(const Instruction &instr, InstructionResult &result)
    {
        // operands
    ...
    void Cpu::JumpImm16(const Instruction &instr, InstructionResult &result)
    {
        // fetch
        uint16_t adr16 = GetImm16(result);
    ...
    void Cpu::JumpCC_Imm16(const Instruction &instr, InstructionResult &result)
    {
        // fetch
    ...
    void Cpu::JumpRelativeImm8(const Instruction &instr, InstructionResult &result)
    {
        // fetch
        uint8_t offset = GetImm8(result);

        // execute
        _JumpRelative(offset, result);
    }

    void Cpu::JumpRelativeCC_Imm8(const Instruction &instr, InstructionResult &result)
    {
        // fetch
    ...
    void Cpu::Return(const Instruction &instr, InstructionResult &result)
    {
        // pop top adress
        uint16_t topAdr16 = Pop(result);
    ...
    void Cpu::ReturnCC(const Instruction &instr, InstructionResult &result)
    {
        auto cc = instr.GetOperand<OperandCond>(0);
        result.Cycles++;
    ...
    void Cpu::ReturnAndEnableInterrupts(const Instruction &instr, InstructionResult &result)
    {
        EnableInterrupts(instr, result);
        Return(instr, result);
    }
